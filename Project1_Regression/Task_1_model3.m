...
if ~exist('../results/Regression/Reg_3', 'dir')
   mkdir('../results/Regression/Reg_3')
end
...
Model = genfis1(trnData, 2, 'gbellmf','linear');
...
saveas(gcf,'../results/Regression/Reg_3/MFs_before_training.png')
...
saveas(gcf,'../results/Regression/Reg_3/MFs_after_training.png')
...
saveas(gcf,'../results/Regression/Reg_3/Learning_Curve.png')
...
saveas(gcf,'../results/Regression/Reg_3/Prediction_errors.png')
...
%% R^2 = 0.772828 RMSE = 3.303554  NMSE = 0.226417 NDEI = 0.475833
%% Elapsed time is 31.240377 seconds.
