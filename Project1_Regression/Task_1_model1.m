...
if ~exist('../results/Regression/Reg_1', 'dir')
   mkdir('../results/Regression/Reg_1')
end
...
Model = genfis1(trnData, 2, 'gbellmf','constant');
...
saveas(gcf,'../results/Regression/Reg_1/MFs_before_training.png')
...
saveas(gcf,'../results/Regression/Reg_1/MFs_after_training.png')
...
saveas(gcf,'../results/Regression/Reg_1/Learning_Curve.png')
...
saveas(gcf,'../results/Regression/Reg_1/Prediction_errors.png')
...
%% R^2 = 0.676277 RMSE = 3.943581  NMSE = 0.322648 NDEI = 0.568021
%% Elapsed time is 5.692488 seconds.
