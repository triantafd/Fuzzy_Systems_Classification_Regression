...
if ~exist('../results/Regression/Reg_2', 'dir')
   mkdir('../results/Regression/Reg_2')
end
...
Model = genfis1(trnData, 3, 'gbellmf','constant');
...
saveas(gcf,'../results/Regression/Reg_2/MFs_before_training.png')
...
saveas(gcf,'../results/Regression/Reg_2/MFs_after_training.png')
...
saveas(gcf,'../results/Regression/Reg_2/Learning_Curve.png')
...
saveas(gcf,'../results/Regression/Reg_2/Prediction_errors.png')
...
%% R^2 = 0.847621 RMSE = 2.705619  NMSE = 0.151873 NDEI = 0.389709
%% Elapsed time is 116.979997 seconds.
