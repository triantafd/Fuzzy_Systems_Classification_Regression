...
if ~exist('../results/Classification/Cls_3', 'dir')
   mkdir('../results/Classification/Cls_3')
end
...
saveas(gcf,'../results/Classification/Cls_3/MFs_before_training.png')
...
saveas(gcf,'../results/Classification/Cls_3/MFs_after_training.png')
...
saveas(gcf,'../results/Classification/Cls_3/Learning_Curve.png')
...
%{ 
OA = 0.704918 K = 0.132701 
PA = 0.764706 
PA = 0.400000 
UA = 0.866667 
UA = 0.250000 
%}
%% Elapsed time is 7.944546 seconds.