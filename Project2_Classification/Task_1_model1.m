...
if ~exist('../results/Classification/Cls_1', 'dir')
   mkdir('../results/Classification/Cls_1')
end
...
options.ClusterInfluenceRange = 0.2;
...
saveas(gcf,'../results/Classification/Cls_1/MFs_before_training.png')
...
saveas(gcf,'../results/Classification/Cls_1/MFs_after_training.png')
...
saveas(gcf,'../results/Classification/Cls_1/Learning_Curve.png')
...
%{ 
OA = 0.590164  K = 0.001310 
PA = 0.738095 
PA = 0.263158 
UA = 0.688889 
UA = 0.312500 
%}
%% Elapsed time is 7.959255 seconds.